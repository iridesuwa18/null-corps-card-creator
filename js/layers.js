...
(function () {
  ...
  /* ══════════════════════════════════════════════════════════════
     MOBILE DISPLAY
     The real #card-stage is CSS-scaled to fit the viewport on all
     screen sizes. GPU compositing is handled via will-change:transform
     and contain:strict in styles.css — no proxy canvas needed.
     _PROXY_ID is kept so the exportPNG cleanup path is a no-op.
  ══════════════════════════════════════════════════════════════ */

  /** ID stub — no proxy canvas is created; kept for exportPNG compat. */
  ...
  /** No-op — proxy canvas removed; real stage renders at full quality. */
  function _scheduleMobileComposite() {}

  /** No-op stub kept for any external callers. */
