...
(function () {
  ...
  function exportPNG() {
    ...
    // Hide Layer 29 from html2canvas. We will draw it perfectly using
    // the custom _drawEffectOnCanvas renderer afterwards.
    ...
    .then((canvas) => {
      // ── Draw Layer 29 Manually (Rich Text & Icons) ────────────────────
      // Preload icons, then draw the text/icons using the custom Canvas API
      return _preloadIconImages(window.NullCorps.state).then(iconImgs => {
