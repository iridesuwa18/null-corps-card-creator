...
(function () {
  ...
  function _applyTextStyles(el, def) {
    ...
    if (def.align === 'center' && !def.confined) {
    ...
    if (def.confined && def.confinedW) {
      ...
      if (def.align === 'center') {
        ...
        cssLines.push('align-items: flex-end');
      }
    }
    ...
    if (def.confined && def.confinedW) {
      ...
      inner.style.cssText = 'width:100%;display:flex;flex-direction:column;justify-content:center;min-height:100%;';
