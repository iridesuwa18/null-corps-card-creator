/* ═══════════════════════════════════════════════════════════════
   ...
   ─────────────────────────────────────────────────────────────
   Manages all 35 card layers in z-order (Layer 1 = top, 35 = bottom).
...
(function () {
  ...
  const LAYER_DEFS = [
    ...
    /* ── Layer 29: Card Effect Description (Text, confined box) ── */
    {
      id: 29, name: 'Card Effect Description', type: 'text',
      value: (s) => s.cardEffect || '',
      x: 1125.6, y: 2688.1,
      font: 'Archivo ExtraCondensed Light', size: 17,
      color: '#000000', outlineColor: '#ffffff', outlineWidth: 4,
      align: 'center', baseline: 'top',
      confined: true,
      confinedW: 2000.7,
   ...
   * Layer 35 is inserted first (bottom); Layer 1 last (top).
