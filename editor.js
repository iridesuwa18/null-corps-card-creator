...
(function () {
  ...
  const FONT_OPTIONS = [
    { label: 'TGL Engschrift',              value: 'TGL Engschrift'              },
    { label: 'Archivo',                     value: 'Archivo'                     },
    { label: 'Archivo ExtraCondensed',      value: 'Archivo ExtraCondensed'      },
    { label: 'Archivo ExtraCondensed Light',value: 'Archivo ExtraCondensed Light'},
